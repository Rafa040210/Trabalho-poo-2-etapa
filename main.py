                ...
                if confirmacao == "s":
                    ...
                    if tipo_usuario == 1:
                        ...
                        if opcao_prof == 1:
                            ...
                            if tipo == 1:
                                codigo = int(input("Informe o código da sala:"))

                                turma.ver_alunos_turma(codigo) # não está funcionando
